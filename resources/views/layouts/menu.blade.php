<nav class="uk-navbar-container navbar navbar-interno" uk-navbar>
  <div class="uk-navbar-left btn-menu-mobile">
    <a class="uk-navbar-toggle uk-hidden@m" uk-toggle="target: #offcanvas-push" uk-navbar-toggle-icon data-btn-mobile
      href="#"></a>
    <span class="uk-text-small uk-hidden@m">MENU</span>
  </div>

  @if($menu == "login" || $menu == "cadastro" || $menu == "redefinir-senha" || $menu == "criar-nova-senha")
  ...
  <div class="uk-navbar-right uk-visible@m">
    <ul class="uk-navbar-nav menu">
      ...
      <li>
        <a href="#"
          class="@if((request()->is('terreo*')) || (request()->is('primeiroandar*')) || (request()->is('segundoandar*'))) active @endif">Andares</a>
        <div class="uk-navbar-dropdown">
          <ul class="uk-nav uk-navbar-dropdown-nav">
            ...
            <li>
              <a href="{{route('primeiroandar.index')}}" class="@if(request()->is('primeiroandar*')) active @endif">1º
                Andar</a>
            </li>
            <li>
              <a href="{{route('segundoandar.index')}}" class="@if(request()->is('segundoandar*')) active @endif">2º
                Andar</a>
            </li>
          </ul>
        </div>
...
<div id="offcanvas-push" uk-offcanvas="mode: push; overlay: true" data-menu-mobile>
  <div class="uk-offcanvas-bar menu-mobile">
    <a class="uk-navbar-item uk-logo" href="{{route('home')}}">
      <img src="{{secure_asset('img/logo-sair-mobile.svg')}}" alt="Logo do site">
    </a>
    <hr class="divisor">
    <ul uk-nav>
      @if(Route::has('login'))
