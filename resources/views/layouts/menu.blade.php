<nav class="uk-navbar-container navbar navbar-interno" uk-navbar>
  <div class="uk-navbar-left btn-menu-mobile">
    <a class="uk-navbar-toggle uk-hidden@m" uk-toggle="target: #offcanvas-push"
      uk-navbar-toggle-icon data-btn-mobile href="#"></a>
    <span class="uk-text-small uk-hidden@m">MENU</span>
  </div>

  @if($menu == "login" || $menu == "cadastro" || $menu == "redefinir-senha" ||
  $menu == "criar-nova-senha")
    ...
    <ul class="uk-navbar-nav menu">
      ...
      <li>
        <a href="{{route('perfil.index')}}"
          class="@if(request()->is('perfil*')) active @endif">Perfil</a>
      </li>
      ...
      <li>
        <a class="uk-button uk-border-rounded"
...
<div id="offcanvas-push" uk-offcanvas="mode: push; overlay: true"
  ...
  <div class="uk-offcanvas-bar menu-mobile">
    <a class="uk-navbar-item uk-logo" href="{{route('home')}}">
      <img src="{{secure_asset('img/logo-sair-mobile.svg')}}"
        alt="Logo do site">
    </a>
    <hr class="divisor">
    <ul uk-nav>
